                        ...
                        {filteredCategory.map(item =>
                        {
                            if (selectedCategory === item)
                            {
                                ...
                                return (
                                    ...
                                    <button type="button" class="btn btn-dark btn-sm rounded-pill ml-1 mr-1 pr-4 pl-4" onClick={() => handleChangeCategory(item)}>{item.toUpperCase()}</button>
                                )
                            }
                            else
                            {
                                return (
                                    <button type="button" class="btn btn-outline-dark rounded-pill btn-sm ml-1 mr-1 pr-2 pl-2" onClick={() => handleChangeCategory(item)}>{item.toUpperCase()}</button>
                                )
                            }
                        })}
                    
                    </div>
                    <div class="col d-flex mr-3 justify-content-end">
                        <div class="dropdown">
                            <button class="btn btn-secondary bg-light text-dark rounded-pill dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Sort By
                            </button>
                            <div class="dropdown-menu text-dark mr-5 pr-5" aria-labelledby="dropdownMenuButton">
                                <button class="dropdown-item active" onClick={() => handleSort(sortOptions["low-high"])}>
                                    Price Low to High
                                </button>
                        ...
                        filteredProductList.map(item =>
                        {
                            ...
                            return (
                                ...
                                <div class="row d-flex justify-content-between">
                                    <div class=" col col-sm-12 col-md-3 col-lg-3  p-4" >
